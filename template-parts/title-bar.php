<?php
  ...
  <?php endif;
	...
	if ( !has_post_thumbnail( $post->ID ) && $title_bar === 'bs-featured-image' ) : ?>
		...
		<header class="featured-hero featured-hero-title-bar" role="banner" style="background: url(<?php echo $default_image; ?>) no-repeat center center; background-size: cover;"></header>
